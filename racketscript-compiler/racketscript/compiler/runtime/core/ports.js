...
export const standardOutputPort = new NewlineFlushingOutputPort(console.log.bind(console));
export let currentOutputPort = standardOutputPort;

export const standardErrorPort = new NewlineFlushingOutputPort(console.log.bind(console));
